...
WebUI.setText(findTestObject('Object Repository/Page_Coding.ID - Update Profile/input_Fullname_name'), '')

WebUI.setText(findTestObject('Object Repository/Page_Coding.ID - Update Profile/input_Phone_whatsapp'), '088877776666')
...
WebUI.verifyElementText(findTestObject('Page_Coding.ID - Update Profile/strong_The name field is required'), 'The name field is required.')
